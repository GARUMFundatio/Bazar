module FavoritosHelper
  ...
  def helper_favo(bazar, empresa, pre)
    ...
    if (!fav.nil?)
      ...
      "<div id='#{pre}-favo#{bazar}-#{empresa}' class='favoritos'><a href='#' title='Agregar a Favoritos' onclick='$(\"\##{pre}-favo#{bazar}-#{empresa}\").load(\"/favorito/addfav?bazar=#{bazar}&empresa=#{empresa}&pre=#{pre}\")'><img src='images/addfav.png'></a></div>".html_safe
    end
  end 
end
