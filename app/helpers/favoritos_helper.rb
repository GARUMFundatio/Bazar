module FavoritosHelper
  ...
  def helper_favo(bazar, empresa)
    ...
    if (!fav.nil?)
      ...
      "<div id='favo#{bazar}-#{empresa}' class='favoritos'><a href='#' onclick='$(\"\#favo#{bazar}-#{empresa}\").load(\"/favorito/addfav?bazar=#{bazar}&empresa=#{empresa}\")'><img src='images/addfav.png'></a></div>".html_safe
    end
  end 
end
