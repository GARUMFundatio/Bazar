class HomeController < ApplicationController
  ...
  def index
    ...
    @empresasrecientes = Bazarcms::Empresa.where("1 = 1").order("created_at desc").limit(9) #created_at BETWEEN (CURDATE() - INTERVAL 30 DAY) AND CURDATE() and nombre not like 'Escriba%' ")
